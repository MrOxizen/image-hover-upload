...
class Effects2 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-light-style-2', OXI_IMAGE_HOVER_UPLOAD_URL . '/Lightbox/Files/style-2.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
        wp_enqueue_style('MagnificPopup', OXI_IMAGE_HOVER_UPLOAD_URL . '/Lightbox/Files/MagnificPopup.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }


    public function public_jquery()
    {
        wp_enqueue_script('MagnificPopup', OXI_IMAGE_HOVER_UPLOAD_URL . '/Lightbox/Files/MagnificPopup.js', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
