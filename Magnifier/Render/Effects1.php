...
class Effects1 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('image_zoom.css', OXI_IMAGE_HOVER_UPLOAD_URL . '/Magnifier/Files/image_zoom.min.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }


    public function public_jquery()
    {
        wp_enqueue_script('image_zoom', OXI_IMAGE_HOVER_UPLOAD_URL . '/Magnifier/Files/image_zoom.min.js', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
