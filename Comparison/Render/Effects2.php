...
class Effects2 extends Public_Render
{
    ...
    public function public_css()
    {
        ...
        wp_enqueue_style('oxi-image-hover-comparison-style-2', OXI_IMAGE_HOVER_UPLOAD_URL . '/Comparison/Files/style-2.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
        wp_enqueue_style('oxi-addons-main-wrapper-image-comparison-style-2', OXI_IMAGE_HOVER_UPLOAD_URL . '/Comparison/Files/BeerSlider.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }

    public function public_jquery()
    {
        $this->JSHANDLE = 'jquery-BeerSlider';
        wp_enqueue_script('jquery-BeerSlider', OXI_IMAGE_HOVER_UPLOAD_URL . '/Comparison/Files/BeerSlider.js', true, OXI_IMAGE_HOVER_PLUGIN_VERSION);
     }
